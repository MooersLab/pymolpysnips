## **pymolpysnipts** library to support literate programming with PyMOL

This is the pymmolspysnips library that has PyMOL pml code enclosed in cmd.do() functions.
...
This readme files has text that is largely limited to unique features that pertain to the pymolpysnips library.
...
PyMOL scripts can encoded in electronic notebooks, integrated development environments, and text editors.
